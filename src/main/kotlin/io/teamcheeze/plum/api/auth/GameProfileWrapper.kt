package io.teamcheeze.plum.api.auth
...
data class GameProfileWrapper(
    ...
    data class TextureProfile(val value: String, val signature: String) {
        ...
        /**
         * A private class that loads texture data from mojang's io.teamcheeze.plum.api server to the instance.
         * @return The current instance that this method is called from.
         */
        @Deprecated("Currently deprecated for maintenance", ReplaceWith("Currently unavailable", "io.github.teamcheeze.plum.io.teamcheeze.plum.api.auth.GameProfileWrapper.TextureProfile"))
