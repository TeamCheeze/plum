package io.teamcheeze.plum.api.core.command
...
class CommandRegistry {
    ...
    companion object {
         ...
         *
         * ***Features***
         * - Simple and LightWeight: The CommandRegistry feature doesn't depend on other dependencies except the spigot-io.teamcheeze.plum.api
